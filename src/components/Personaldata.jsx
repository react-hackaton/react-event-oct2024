        ...
        <Container sx={{ 
            ...
            <Typography variant="h6" sx={{ mb: 1.5 }}>Локация для помощи</Typography>  
                ...
                <Stack direction="row" spacing={(.5)} sx={{mb:2}}>
                    <Typography variant="subtitle2" sx={{ fontSize: '14px', mb:0.5 }}><strong>Населённый пункт: </strong></Typography>
            ...
            <Typography variant="h6" sx={{ mb: 1.5 }}>Образование</Typography>
                ...
                <Stack direction="row" spacing={(.5)}>
                    <Typography variant="subtitle2" sx={{ fontSize: '14px', mb:0.5 }}><strong>Уровень образования: </strong></Typography>
                    <Typography variant="body2" sx={{ fontSize: '14px', mb:0.5 }}> Средний общий</Typography>
                </Stack>
                <Stack direction="row" spacing={(.5)} sx={{mb:2}}>
                    <Typography variant="subtitle2" sx={{ fontSize: '14px', mb:0.5 }}><strong>Год окончания: </strong></Typography>
                    <Typography variant="body2" sx={{ fontSize: '14px', mb:2 }}> 2010</Typography>
                </Stack>

                <Stack direction="row" spacing={(.5)}>
                    <Typography variant="subtitle2" sx={{ fontSize: '14px', mb:0.5 }}><strong>Учреждение: </strong></Typography>
                    <Typography variant="body2" sx={{ fontSize: '14px', mb:0.5 }}> Московский государственный университет имени М. В. Ломоносова</Typography>
                </Stack>
                <Stack direction="row" spacing={(.5)}>
                    <Typography variant="subtitle2" sx={{ fontSize: '14px', mb:0.5 }}><strong>Уровень образования: </strong></Typography>
                ...
                <Stack direction="row" spacing={(.5)}>
                    ...
                    <Typography variant="body2" sx={{ fontSize: '14px', mb:0.5}}> Информатика и вычислительная техника</Typography>
                </Stack>
                <Stack direction="row" spacing={(.5)}>
                    <Typography variant="subtitle2" sx={{ fontSize: '14px', mb:0.5 }}><strong>Год окончания: </strong></Typography>
