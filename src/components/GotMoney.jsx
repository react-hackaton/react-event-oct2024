    ...
    return(
        <Card sx={{
            ...
            <CardContent>
                ...
                <Stack width="280px">
                    <Typography variant="subtitle2" sx={{ fontSize: "14px", mb: 1 }}><strong>Цель сбора</strong></Typography>
                ...
                <Stack>
                    <Typography variant="subtitle2" sx={{ fontSize: "14px", mt: 2, mb: 1 }}><strong>Завершение</strong></Typography>
                    <Typography variant="body2" sx={{ fontSize: "14px" }}>20.03.2025</Typography>
                </Stack>

                <Stack>
                    <Typography variant="subtitle2" sx={{ fontSize: "14px", mt: 2, mb: 1 }}><strong>Мы собрали</strong></Typography>
                ...
                <Typography variant="body2" sx={{ fontSize: "14px", mt: 5 }}>Нас уже: 3 566 987</Typography>
                
                <Button
                    variant="contained"
                    color="primary"
                    fullWidth
                    sx={{ borderRadius: "0px", mt: 3 }}>
                    ПОМОЧЬ
                </Button>
            </CardContent>
        </Card>
